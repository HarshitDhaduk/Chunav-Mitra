  ...
  return (
    <div className="flex flex-col items-center gap-6 rounded-2xl border-2 border-gray-300 bg-gray-100 p-8">
      <div className="text-center">
        <p className="text-xs font-bold uppercase tracking-widest text-gray-500">Control Unit</p>
        <p className="mt-1 text-sm text-gray-600">Operated by the 3rd Polling Official</p>
      </div>

      {/* Status light */}
      <div className="flex items-center gap-2">
        <div className="h-3 w-3 rounded-full bg-red-500" />
        <span className="text-xs text-gray-500">Waiting for voter</span>
      </div>
      ...
      <motion.button
        ...
        aria-label="Press Ballot button to release EVM"
      >
        BALLOT
      </motion.button>
